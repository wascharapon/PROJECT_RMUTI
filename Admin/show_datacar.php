  ...
  <body class="app sidebar-mini">
          ...
          <h3 class="tile-title">รถประจำทาง</h3>
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <?php 
				include'php/show_data_action.php';
	...
	{	
                 echo "  <tr>
					...
					?>
                    <td><img src="../User/img/car/<?php echo $row['Logo'] ?>" width="100%"></td>
                    <td> <center><button class="btn btn-primary" onclick="window.location.href='edit_datacar.php?id=<?php echo $row['ID'];?> '">แก้ไขข้อมูล</button></center> </td>  </tr>
					<?php }   ?>
