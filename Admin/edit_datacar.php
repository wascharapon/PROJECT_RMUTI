<?php include'php/edit_location_action.php'; ?>
...
<html lang="en">
  ...
  <li class="dropdown"><a class="app-nav__item" href="php/logout_action.php" ><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> แก้ไข</h1>
          <p></p>
        </div>
 
      </div>
                   <?php 
				  include'php/edit_datacar_action.php';
	...
	?>
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">แก้ไขข้อมูลรถประจำทาง</h3>
            <div class="tile-body">
                    <img src="../User/img/car/<?php echo $row['Logo'];?>" width="100%">
              <form action="php/update_datacar_active.php" method="post" enctype="multipart/form-data">
                <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                  <label class="control-label">เลขประจำสายรถ</label>
                  <input class="form-control" name="No" type="number" value="<?php echo $row['No']; ?>" placeholder="">
                </div>
                <div class="form-group">
                  <label class="control-label">เวลารับ-ส่ง</label>
                  <input class="form-control" name="Time" type="text" value="<?php echo $row['Time']; ?>" placeholder="">
                </div>
                <div class="form-group">
                  <label class="control-label">ค่าโดยสาร</label>
                        <input class="form-control" name="Fare" type="number" value="<?php echo $row['Fare']; ?>" placeholder="">
                </div>
                     <div class="form-group">
           ...
           <div class="tile">
            <div class="tile-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-8">
                    <textarea class="form-control" rows="4" name="Route_TH"  placeholder="Enter your address"><?php echo $row['Route_TH']; ?></textarea>
                  </div>
                     <br><br><br><br><br>
                      <label class="control-label col-md-3">ทางเดินรถ(ENG)</label>
                  <div class="col-md-8">
                    <textarea class="form-control" rows="4" name="Route_ENG" placeholder="Enter your address"><?php echo $row['Route_ENG']; ?></textarea>
                  </div>
            ...
            <div class="tile-footer">
              ...
              <a class="btn btn-secondary" href=""><i class="fa fa-fw fa-lg fa-times-circle"></i>ยกเลิก</a>
				<a class="btn btn-primary_a"  href="php/delete_datacar_active.php?No=<?php echo $row['No'] ?>"><i class="fa fa-fw fa-lg fa-times-circle"></i>ลบข้อมูล</a> 
                </div>
              </div>
                </form>
            </div>
