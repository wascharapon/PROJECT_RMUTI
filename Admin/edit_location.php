...
<html lang="en">
  ...
  <li class="dropdown"><a class="app-nav__item" href="php/logout_action.php" ><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>เพื่มข้อมูล</h1>
	...
	?>
      <div class="row">
        <div class="col-md-5">
          <div class="tile">
            <h3 class="tile-title">เพิ่มข้อมูลสถานที่</h3>
            <div class="tile-body">
              <form action="php/update_location_active.php" method="post" >
                <div class="form-group">
                	<input type="hidden" name="id" value="<?php echo $_GET['id']; ?>">
                  <label class="control-label">ชื่อสถานที่ (ไทย)</label>
                  <input class="form-control" name="Name_TH" type="text" placeholder="" value="<?php echo $row['Name_TH']; ?> "required>
                </div>
                    <div class="form-group">
                  <label class="control-label">ชื่อสถานที่ (อังกฤษ)</label>
                  <input class="form-control" name="Name_ENG" type="text" placeholder="" value="<?php echo $row['Name_ENG']; ?> "required>
                </div>
                <div class="form-group">
                  <label class="control-label">สายรถประจำทาง</label>
                  <input class="form-control" name="No_car" type="number" placeholder="" value="<?php echo $row['No_car']; ?>"required >
                </div>
          <div class="form-group">
                  <label class="control-label">ละติจูด</label>
                  <input class="form-control" name="Lat" type="text" placeholder=""value="<?php echo $row['Lat']; ?> "required>
                </div>
                     <div class="form-group">
                  <label class="control-label">ลองจิจูด</label>
                  <input class="form-control" name="Lng"  type="text" placeholder=""value="<?php echo $row['Lng']; ?> "required>
                </div>
            ...
            <div class="tile-footer">
             ...
             <a class="btn btn-primary_a"  href="php/delete_location_active.php?id=<?php echo $_GET['id']; ?>"><i class="fa fa-fw fa-lg fa-times-circle"></i>ลบข้อมูล</a> 
            </div>
               </form>
          </div>
        </div>
