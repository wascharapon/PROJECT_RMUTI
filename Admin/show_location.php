      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i>&nbsp;ตารางข้อมูล</h1>
                ...
                <?php 
				include'php/show_location_action.php';
				?>
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
          <h3 class="tile-title" style="color:red"> ลบสถานที่ทั้งหมด</h3>
      
          <form action="php/delete_location_car.php" method="post">
          <br>
      	 <select style="width:100px;height:33px" name="car">
                  <?php
			while ($row_a = mysqli_fetch_array($rs_a))
	{	?>
 		 <option  value="<?php echo $row_a['No_car'] ?>"><?php echo $row_a['No_car'] ?></option>
            ...
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                <thead>
                  <tr>
                  <center>
                    	<th width="120px">สายรถประจำทาง</th>
                    	<th>ชื่อ(ไทย)</th>
                      <th>ชื่อ(อังกฤษ)</th>
                   		 <th>ลองติจูด</th>
                      <th>ลองจิจูด</th>
