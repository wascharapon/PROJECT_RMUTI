...
<!DOCTYPE html>
	...
	<div id="fh5co-page">
		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<h1 id="fh5co-logo"><a href="../admin/index.php"><img src="img/RMUTI.png"width="150"  height="220" ></a></h1>
		...
		<form action="search_data.php" method="post"> 
			...
			if($rs = @mysqli_query($con, $sql))
		    {
				...
				<?php echo $bn[$cheking];?>
					...
					?>
		   &nbsp;<input style="margin-top:50px" type="text" name="search" >
                       	<?php 
							
			$sql = "SELECT * FROM vocabulary WHERE ID = 6";
			...
			if($rs = @mysqli_query($con, $sql))
		    {
				...
				<input type="submit" value="<?php echo $bn[$cheking];?>">
                      <?php 
							}
			}
					?>
